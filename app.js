...
var createNewTaskElement = function (taskString) {
  ...
  label.className = "label todo__name";

  //Each elements, needs appending
  listItem.className = "todo__item";

  checkBox.type = "checkbox";
  checkBox.className = "todo__radio";
  editInput.type = "text";
  editInput.className = "todo__input";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "button todo__button-edit";

  deleteButton.className = "button todo__button-delete";
  deleteButtonImg.src = "./remove.svg";
  deleteButtonImg.classList = "todo__button-image";
...
var editTask = function () {
  ...
  listItem.classList.toggle("todo__item-editMode");
};
